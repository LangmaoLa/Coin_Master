...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        collector.on('collect', async collected => {
            ...
            let winner = 0;
            if((botChoice == 2 && playerChoice == 0) || (botChoice == 1 && playerChoice == 2) || (botChoice == 0 && playerChoice == 1))
                winner = 2;
            if((botChoice == 0 && playerChoice == 2) || (botChoice == 2 && playerChoice == 1) || (botChoice == 1 && playerChoice == 0))
                winner = 1;
